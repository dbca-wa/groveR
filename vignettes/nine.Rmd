...
This boundary needs to be supplied in a shape file. Convention has it that an attribute column, 
named "region" contains a region name and a site name separated by an underscore. 
An example might be "lgscmp_east", "lgscmp_west" etc. This should be the same shape file that was 
...
irast <- "trend_class/lgscmp_2014-2023_trendclass.tif"
...
![Trend class area example](plots/trendclassarea.png)
