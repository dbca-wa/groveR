...
![Directory tree with example data](plots/dirtree2.png)
...
![Directory tree with index data](plots/dirtree3.png)
...
Lastly there are a couple of shape files in the vectors directory. One provides 
