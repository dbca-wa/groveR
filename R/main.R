...
#' @param ext Character representation of the desired file type output. Common
#'     types include ".tif" and ".img".
...
#' A function to apply specific masks to rasters in bulk.
#'
...
#'     input rasters only.
#'
#' @details The "specific_mask" form of functions, apply a pre-generated mask to
...
#'     rasters. This aids in not selecting additional files generated by other
#'     software (e.g. ArcMap).
#' @param imask Character file path to directory of specific raster masks to
#'     apply. Commonly something like `raster_masks\cloud_masks\`.
#' @param maskkey Character representation of the file extension of the raster
#'     masks.
#'
#' @return Any specific masking will carried out to affected input rasters and
...
#' A function to apply specific masks to one or a selection of rasters.
#'
#' \code{specific_mask_select} takes multiple input rasters and applies
...
#'     and cell size.
#'
#' @inheritParams specific_mask_bulk
...
#' @examples
#' \dontrun{
#' specific_mask_select(irast = "./veg_dens_mskd_for_trends", rastkey = ".tif",
#'     imask = "Z:/DEC/projectXX/processing/raster_masks/cloud_masks",
...
#'    created by using the "specific_mask" functions.
#'
...
#'     through the specific masking process, i.e. those that are found in
#'     `veg_dens_mskd_for_class\`.
#' @param rastkey Character representation of unique string to match in intended
#'     rasters. This aids in not selecting additional files generated by other
#'     software (e.g. ArcMap).
#' @param imask Character file path to directory of raster masks that were
#'     applied using a "specific_mask" function. If there were none or you would
#'     prefer that no "probable" classifications be carried out use FALSE.
#' @param maskkey Character representation of the file extension of the raster
#'     masks.
#' @param classes Character representation of the name of the density classes
#'     csv file including file path.
#'
#' @return All input rasters will be reclassified and be written to
#'     `veg_class_cloud_prob/`.
#'
#' @author Bart Huntley, \email{bart.huntley@@dbca.wa.gov.au}
#'
#' @examples
#' \dontrun{
#' veg_class(irast = "./veg_dens_mskd_for_class", rastkey = ".tif",
#'     imask = "Z:/DEC/projectXX/processing/raster_masks/cloud_masks",
#'     maskkey = ".ers", classes = "./supplementary/density_classes.csv")
#' }
#'
#' @import dplyr
#' @importFrom fs dir_ls file_copy
...
#'     Reporting areas are defined by input shape file. Outputs results to csv.
#'
#' @param irast Character file path to input veg density rasters that have been
...
#'
#' @param irast Character file path to input veg density rasters that have been
#'     masked and found in `veg_dens_mskd_for_trends\`.
#' @param rastkey Character representation of unique string to match in intended
#'     rasters. This aids in not selecting additional files generated by other
#'     software (e.g. ArcMap).
...
#' @examples
#' \dontrun{
#' change_extent(irast = "./veg_class_cloud_prob", rastkey = ".img",
#'     iregions = "./vectors/regions.shp", attribname = "regions")
#' }
#'
#' @import dplyr
    ...
    rastdf <- dplyr::tibble(path = irs) %>%
      ...
      dplyr::mutate(pathnew = stringr::str_replace(path, "veg_class_cloud_prob",
                    ...
                    pathnew1 = stringr::str_replace(pathnew, "Veg_Class_Cloud_Probabilities_",
                                                    "extent_change_"),
                    pathnew2 = stringr::str_replace(pathnew1, paste0("AA", rastkey),
                                                    paste0(yr-1, rastkey)))
